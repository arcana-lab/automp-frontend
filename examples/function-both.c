...
/* NOTE(Simone): if the annotations disagree, the definition will win
 * because it is parsed 2nd. So, no lies.
 */
#pragma note noelle hahaha = lies
void this_function_is_annotated (void);
void this_function_is_not (void);

// NOTE(Simone): Here's the erm... real annotation.
