...
void CodeGenFunction::InsertHelper(llvm::Instruction *I,
  ...
  // PRAGMA-NOTE(Simone): run insert helper when it is enabled
  if (note::codegen::isInsertHelperEnabled(getContext()))
    note::codegen::InsertHelper(I, getContext(), I->getContext());
}
