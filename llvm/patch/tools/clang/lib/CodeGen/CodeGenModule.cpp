...
// PRAGMA-NOTE(Simone): include codegen; see EmitGlobalFunctionDefinition
...
void CodeGenModule::EmitGlobalFunctionDefinition(GlobalDecl GD,
  ...
  // PRAGMA-NOTE(Simone): enable function-wide annotation (if any)
  bool has_note = note::codegen::EnableInsertHelper(
    (void *)(D->getCanonicalDecl()),
    getContext(),
    getLLVMContext()
  );
  ...
  // PRAGMA-NOTE(Simone): stop emitting the function-wide annotation
