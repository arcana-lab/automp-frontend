...
// PRAGMA-NOTE: include InsertHelperData and Annotation
#include "../../../tools/hobbit-tricks/pragma-note/insert-helper-data.h"
...
public:
  // PRAGMA-NOTE: mapping from AST nodes (void *) to DSL metadata
  note::AnnotationMap NoteDSLAnnotations;
  note::InsertHelperData NoteInsertHelperData;
